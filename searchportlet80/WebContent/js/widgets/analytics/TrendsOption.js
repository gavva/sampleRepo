...
// @endCopyright
//*********************** ES COPYRIGHT END  ***********************************
dojo.provide("widgets.analytics.TrendsOption");
...
dojo.declare(
	"widgets.analytics.TrendsOption", [dijit._Widget, dijit._Templated],
	{				
		prefix: EDR.prefix,
		widgetsInTemplate: true,
		templatePath: dojo.moduleUrl("widgets.analytics", "templates/TrendsOption.html"),
		_autoLoad: false,
		handlers: [],				
		...
		getFormValues: function() {
			var values = dojo.formToObject(this.analytcsTrendsOptionsForm);
			return values;
		},
		...
		validate: function(params) {
			...
			if (!this.numberOfResults.isValid()) {
				errors += this.messages_preferences_analytics_trends_numberOfResults + " : " + this.numberOfResults.invalidMessage + "<br/><br/>";
			}			
			if (!this.numberOfCharts.isValid()) {
				errors += this.messages_preferences_analytics_trends_numberOfCharts + " : " + this.numberOfCharts.invalidMessage + "<br/><br/>";
			}
			if (!this.defaultSortBy.isValid()) {
				errors += this.messages_preferences_analytics_trends_defaultSortBy + " : " + this.defaultSortBy.invalidMessage + "<br/><br/>";
			}
			if (!this.defaultShowTarget.isValid()) {
				errors += this.messages_preferences_analytics_trends_defaultShowTarget + " : " + this.defaultShowTarget.invalidMessage + "<br/><br/>";
			}
			if (!this.defaultTimeScale.isValid()) {
				errors += this.messages_preferences_analytics_trends_defaultTimeScale + " : " + this.defaultTimeScale.invalidMessage + "<br/><br/>";
			}
			if (!this.barColorOfMultiChart.isValid()) {
				errors += this.messages_preferences_analytics_trends_barColorOfMultiChart + " : " + this.barColorOfMultiChart.invalidMessage + "<br/><br/>";
			}
		...
		afterSaveApplyChanges: function(json, isCollectionChanged){
			...
			trendView.verticalRowCount=json.numberOfResults;
			trendView.showLineInChart = json.showLineInChart;
			trendView.barColorOfMultiChart = json.barColorOfMultiChart;
		...
		messages_preferences_analytics_trends_numberOfResults : EDR.messages.preferences_analytics_trends_numberOfResults,
		messages_preferences_analytics_trends_numberOfCharts : EDR.messages.preferences_analytics_trends_numberOfCharts,
		messages_preferences_analytics_trends_showLineInChart : EDR.messages.preferences_analytics_trends_showLineInChart,
		messages_preferences_analytics_trends_defaultSortBy : EDR.messages.preferences_analytics_trends_defaultSortBy,
		messages_preferences_analytics_trends_defaultShowTarget : EDR.messages.preferences_analytics_trends_defaultShowTarget,
		messages_preferences_analytics_trends_defaultTimeScale : EDR.messages.preferences_analytics_trends_defaultTimeScale,
		messages_preferences_analytics_trends_barColorOfMultiChart : EDR.messages.preferences_analytics_trends_barColorOfMultiChart,
